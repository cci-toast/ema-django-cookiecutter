...
SECRET_KEY = '41^ygtv%81$=l)qm*9e@jx1x^@f%@yj)f9w+*sy6_-hshs79dl'
...
ROOT_URLCONF = '{{ cookiecutter.project_dir }}.urls'
...
WSGI_APPLICATION = '{{ cookiecutter.project_dir }}.wsgi.application'
